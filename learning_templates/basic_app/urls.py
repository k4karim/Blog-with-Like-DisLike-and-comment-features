...
urlpatterns=[
    ...
    url(r'^userslist/$',views.profilepagelist,name='profilepagelist'),

    url(r'^post/(?P<pk>\d+)/$', views.post_detail, name='post_detail'),

    url(r'^userprofile/(?P<pk>\d+)/$', views.profilepage, name='profilepage'),
    ...
    url(r'^post/(?P<pk>\d+)/upvote/$',views.like,name='like'),
